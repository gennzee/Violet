								...
								<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
									...
									<div class="block2">
										<div class="block2-pic hov-img0">
											...
											<a href="/product/${p.id}">
												<img src="/images/${p.productImageList[0].name}" alt="IMG-PRODUCT" width="270" height="350" style="object-fit: cover; position: absolute; filter: blur(10px);">
												<img src="/images/${p.productImageList[0].name}" alt="IMG-PRODUCT" width="270" height="350" style="object-fit: contain; position: relative;">
											</a>
