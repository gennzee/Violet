            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Danh sách hóa đơn</h4>
                                        ...
                                        <c:forEach var="order" items="${orderList}">
                                            <tr>
                                                ...
                                                <c:forEach var="orderProduct" items="${order.orderProducts}">
                                                    <c:set var="totalPrice" value="${totalPrice + (orderProduct.quantity * orderProduct.price)}"/>
                                                </c:forEach>
                                                <td><fmt:formatNumber type = "number" value = "${totalPrice}" /> VNĐ</td>
                                                <td>${order.orderDate}</td>
                                                <td><a href="/orderDetail/${order.id}">Chi tiết</a></td>
                                            </tr>
                                        </c:forEach>
                                        </tbody>
                                        <tfoot>
