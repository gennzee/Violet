...
CREATE TABLE `comments` (
  ...
  `created_date` datetime DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  KEY `FKlmoisw3c0wn9m8rfcapi6fha3` (`new_id`),
  CONSTRAINT `FKlmoisw3c0wn9m8rfcapi6fha3` FOREIGN KEY (`new_id`) REFERENCES `news` (`id`)
...
CREATE TABLE `news` (
  ...
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `thumb_image` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `content_image` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `content` mediumtext CHARACTER SET utf8 COLLATE utf8_general_ci,
  `user_id` int DEFAULT NULL,
  `created_date` datetime DEFAULT NULL,
  `updated_date` datetime DEFAULT NULL,
  ...
  CONSTRAINT `FK6itmfjj4ma8lfpj10jx24mhvx` FOREIGN KEY (`category_id`) REFERENCES `categories` (`id`),
  CONSTRAINT `FKi09n75txtudw1kawj5o7i8xag` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
...
CREATE TABLE `order_product` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `FK5drbvt4x6num52s0w58uiixtc` (`product_storage_id`),
  KEY `FK4uojhkcodf6b07m2upka3c8wt` (`order_id`),
  CONSTRAINT `FK4uojhkcodf6b07m2upka3c8wt` FOREIGN KEY (`order_id`) REFERENCES `orderr` (`id`),
  CONSTRAINT `FK5drbvt4x6num52s0w58uiixtc` FOREIGN KEY (`product_storage_id`) REFERENCES `product_storage` (`id`)
...
CREATE TABLE `orderr` (
  ...
  PRIMARY KEY (`id`) USING BTREE,
  KEY `FKfvpvq5dp6hxw3our9oaqy6e2c` (`user_id`),
  CONSTRAINT `FKfvpvq5dp6hxw3our9oaqy6e2c` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
...
CREATE TABLE `product_color` (
  `id` int NOT NULL AUTO_INCREMENT,
  `name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `hex` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `removed_flag` bit(1) DEFAULT NULL,
  `created_date` datetime DEFAULT NULL,
  `updated_date` datetime DEFAULT NULL,
  `category_id` int DEFAULT NULL,
